  ...
  return (
    <section className="my-28 w-9/12 mx-auto">
      <div className="flex justify-between items-center max-sm:flex-col max-sm:gap-16">
        ...
        <img className="w-64 my-3" src="./Companies Logos/crombie.svg" alt="" />
        <img className="w-32" src="./Companies Logos/google.png" alt="" />
        <img src="./Companies Logos/mailchimp.png" alt="" />
      </div>
    </section>
  );
};
