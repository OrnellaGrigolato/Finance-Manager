  ...
  return userInfo ? (
    <div className="bg-bg lg:w-[90vw] lg:ml-[10vw] lg:pt-10">
      ...
      <p className="mb-5 text-xl font-bold hidden w-11/12 mx-auto lg:block">
        {t('welcomeMessage', { username: userInfo?.username?.split(" ")[0] })}
      </p>
      ...
      <div className="w-10/12 mx-auto mt-10">
        <div className="flex justify-between items-center">
          <h4 className="font-bold text-xl ">{t('yourWallet')}</h4>
      ...
      <div className="w-10/12 mx-auto mt-10">
        <div className="flex justify-between items-center">
          <h4 className="font-bold text-xl ">{t('lastMovements')}</h4>
        </div>
