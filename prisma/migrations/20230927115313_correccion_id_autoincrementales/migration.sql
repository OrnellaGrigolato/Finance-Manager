...
*/
-- AlterTable
ALTER TABLE `Currency` MODIFY `id_currency` INTEGER NOT NULL AUTO_INCREMENT;

-- AlterTable
ALTER TABLE `Moves` MODIFY `id_moves` INTEGER NOT NULL AUTO_INCREMENT,
    MODIFY `movement_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
